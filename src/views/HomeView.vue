    ...
    <div class="container">
      ...
      <div class="protect_section_2 layout_padding">
        <div class="row">
          <div class="col-md-6">
            <h1 class="hands_text">
              <a href="#">Wash your <br />hands frequently</a>
            </h1>
            <h1 class="hands_text_2">
              <a href="#">Maintain social <br />distancing</a>
            </h1>
            <h1 class="hands_text">
              <a href="#">Avoid touching eyes,<br />nose and mouth</a>
            </h1>
          </div>
          <div class="col-md-6">
  ...
  <div class="about_section layout_padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="about_taital"><span> Coronavirus what it is?</span></h1>
          <p class="about_text">
